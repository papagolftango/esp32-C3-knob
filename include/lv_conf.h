 ...
 *LV_DITHER_GRADIENT implies LV_GRADIENT_MAX_STOPS = 256 (7bit)*/
#define LV_DITHER_GRADIENT 0
#if LV_DITHER_GRADIENT
    /*Add support for error diffusion dithering.
     *Error diffusion dithering gets a much better visual result, but implies more CPU consumption and memory when drawing.
     *The increase in memory consumption is (32 bits * object width size)*/
...
#if LV_USE_LABEL
    /*0: no selection, 1: support selection*/
    #define LV_LABEL_TEXT_SELECTION 0
    /*0: no long text wrapping, 1: break the long lines*/
...
#if LV_USE_ROLLER
    /*Focus on a value when the infinity transition is enabled*/
